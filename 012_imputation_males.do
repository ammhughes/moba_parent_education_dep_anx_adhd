*SEX-STRATIFIED IMPUTATION AND MAIN MODELS: males ONLY
...
save "scratch/mi_analysis_dataset_pre_males",replace
use "scratch/mi_analysis_dataset_pre_males",clear
...
, add(50) rseed(100) dots savetrace(impstats_males.dta) augment 

compress
save "scratch/impx50_mi_raw_dataset_males", replace
...
save "scratch/impx50_mi_analysis_dataset_males", replace
